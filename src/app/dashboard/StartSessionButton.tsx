...
export function StartSessionButton() {
  ...
  return (
    <button
      ...
      style={{ padding: '14px 26px', borderRadius: 12, border: 'none', background: 'linear-gradient(135deg, #ff7a1a, #ff2d55)', color: '#fff', fontWeight: 800, fontSize: 15, cursor: 'pointer', boxShadow: '0 10px 26px rgba(255,45,85,.4)' }}
    >
