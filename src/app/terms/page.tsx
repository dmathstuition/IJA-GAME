...
export const metadata = { title: 'Terms & Conditions · QuizArena' };

export default function TermsPage() {
  return (
    <LegalLayout title="Terms &amp; Conditions" updated="July 2026">
      <p style={{ marginTop: 0 }}>
        These Terms govern your use of QuizArena, a live quiz platform founded and operated by DMaths Academy.
        By creating an account or using the service you agree to these Terms.
      </p>

      <LegalSection heading="1. The service">
        <p>QuizArena lets schools build question banks and run live quiz competitions (Standard, Team, Speed and Quiz Bowl modes) on their own screens and devices. We may add, change or remove features to improve the product.</p>
      </LegalSection>
      ...
      <LegalSection heading="8. Termination">
        <p>You may stop using QuizArena at any time. We may suspend or terminate accounts that breach these Terms. On termination your right to use the service ends; you may request export or deletion of your data.</p>
      </LegalSection>
